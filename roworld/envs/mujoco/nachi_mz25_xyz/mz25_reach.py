...
from roworld.envs.mujoco.nachi_mz25_xyz.base import MZ25XYZEnv


class MZ25ReachXYZEnv(MZ25XYZEnv, MultitaskEnv):
    def __init__(
            self,
        ...
        MZ25XYZEnv.__init__(self, model_name=self.model_name, **kwargs)
    ...
    @property
    def model_name(self):
        return get_asset_full_path('mz25_xyz/mz25_reach.xml')
...
class MZ25ReachXYEnv(MZ25ReachXYZEnv):
    def __init__(self, *args,
                 fixed_goal=(0.15, 0.6),
                 hand_z_position=0.055, **kwargs):
        self.quick_init(locals())
        MZ25ReachXYZEnv.__init__(
            self,
            *args,
