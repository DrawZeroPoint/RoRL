...
from roworld.envs.env_util import get_stat_in_paths, \
    create_stats_ordered_dict, get_asset_full_path
from roworld.core.multitask_env import MultitaskEnv
from roworld.envs.mujoco.ur5e_xyz.base import UR5eXYZEnv


class UR5eReachXYZEnv(UR5eXYZEnv, MultitaskEnv):
    def __init__(
            self,
        ...
        UR5eXYZEnv.__init__(self, model_name=self.model_name, **kwargs)

        self.reward_type = reward_type
        self.norm_order = norm_order
        self.indicator_threshold = indicator_threshold  # TODO meaning?
    ...
    @property
    def model_name(self):
        return get_asset_full_path('ur5e_sim/ur5e_reach.xml')
    ...
    def reset_model(self):
        ...
        # this is the initial value of the joints
        angles[:6] = [0, 0, 0, 0, 0, 0]
    ...
    def _reset_hand(self):
        for _ in range(10):
            # FIXME adjust init pos according to env (done for ur5e)
            self.data.set_mocap_pos('mocap', np.array([0, 0, 1.]))
...
class UR5eReachXYEnv(UR5eReachXYZEnv):
    def __init__(self, *args,
                 fixed_goal=(0.15, 0.6),
                 hand_z_position=0.95, **kwargs):
        self.quick_init(locals())
        UR5eReachXYZEnv.__init__(
            self,
            *args,
