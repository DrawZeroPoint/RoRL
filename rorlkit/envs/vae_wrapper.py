...
from rorlkit.envs.wrappers import ProxyEnv

from roworld.core.multitask_env import MultitaskEnv
from roworld.envs.env_util import get_stat_in_paths, create_stats_ordered_dict
    ...
    def goal_sampling_mode(self, mode):
        ...
        if mode == 'custom_goal_sampler':
            ...
            if test_goals is None:
                ...
                warnings.warn(
                    "self.goal_sampler returned None. Defaulting to vae_prior goal sampling mode"
                )
