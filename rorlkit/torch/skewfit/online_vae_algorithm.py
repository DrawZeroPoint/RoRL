...
from rorlkit.data_management.online_vae_replay_buffer import \
    OnlineVaeRelabelingBuffer
from rorlkit.data_management.shared_obs_dict_replay_buffer \
    import SharedObsDictRelabelingBuffer
import rorlkit.torch.vae.vae_schedules as vae_schedules
from rorlkit.torch.torch_rl_algorithm import (
...
class OnlineVaeAlgorithm(TorchBatchRLAlgorithm):
    ...
    def _end_epoch(self, epoch):
        # TODO check whether this is executed
